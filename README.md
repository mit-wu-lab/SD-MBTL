...
### Synthetic tasks
3 dimensional
![Synthetic Tasks Results 3D](./figures/result_table_synthetic.png)
![Synthetic Tasks Results Any K](./figures/any_K_plot_synt.png)
5 dimensional
![Synthetic Tasks Results 5D](./figures/result_table_synthetic_5d.png)
7 dimensional
![Synthetic Tasks Results 7D](./figures/result_table_synthetic_7d.png)
### Real-world tasks
...
![Cartpole Walker Any K](./figures/any_K_plot_cartpole_walker.png)
![IntersectionZoo Crop Any K](./figures/any_K_plot_intersectionZoo_crop.png)
## License
